...
threshold.c and hack.c by changing the "ip" global variable. Then you can run hack_script and perform the attack. If you wish, you may add your own username/password pairs to the CREDS global variable in server.c. You may also train the threshold on different data by updating the USERNAME and PASSWORD global variables in threshold.c.
